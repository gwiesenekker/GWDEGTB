...
all: test_index test_combinatorial_index test_egtb test_movegen test_generator test_generator_padded test_material test_bitmap generate_egtb check_stats benchmark_index benchmark_combinatorial_index benchmark_egtb \
	benchmark_movegen

%.o: %.c Makefile
	$(CC) $(CFLAGS) -MMD -MP -c -o $@ $<

generate_egtb: generate_egtb.o generator_padded.o frontier.o bitmap.o material.o movegen.o endgame_index.o egtb.o revision.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)

generate_egtb.o: revision.h

generate_egtb_padded: generate_egtb.o generator_padded.o frontier.o bitmap.o material.o movegen.o endgame_index.o egtb.o revision.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)

generate_egtb_table: generate_egtb.o generator.o frontier.o bitmap.o material.o movegen.o endgame_index.o egtb.o revision.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
test: test_index test_combinatorial_index test_egtb test_movegen test_generator test_generator_padded test_material test_bitmap
	./test_index
	./test_index 0 0 1 1
	./test_index 1 1 1 0
...
clean:
	$(RM) test_index test_combinatorial_index test_egtb test_movegen test_generator test_generator_padded test_material test_bitmap check_stats benchmark_index benchmark_combinatorial_index \
		benchmark_egtb benchmark_movegen test_index.o test_egtb.o \
		test_movegen.o test_generator.o test_material.o test_bitmap.o test_combinatorial_index.o check_stats.o combinatorial_index.o endgame_index.o egtb.o wdl.o movegen.o \
