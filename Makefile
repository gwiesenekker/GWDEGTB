...
all: test_index test_egtb test_movegen test_generator test_material generate_egtb check_stats benchmark_index benchmark_egtb \
	benchmark_movegen

generate_egtb: generate_egtb.o generator.o material.o movegen.o endgame_index.o egtb.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
test_generator: test_generator.o generator.o material.o movegen.o endgame_index.o egtb.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
test: test_index test_egtb test_movegen test_generator test_material
	./test_index
	./test_index 0 0 1 1
	./test_index 1 1 1 0
	./test_egtb
...
clean:
	$(RM) test_index test_egtb test_movegen test_generator test_material check_stats benchmark_index \
		benchmark_egtb benchmark_movegen test_index.o test_egtb.o \
		test_movegen.o test_generator.o test_material.o check_stats.o endgame_index.o egtb.o wdl.o movegen.o \
		generator.o material.o generate_egtb generate_egtb.o
